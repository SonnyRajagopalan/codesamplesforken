 ...
 *
 * (Derived from APPIEvent object) Sent just before the app is going to the background (becomes inactive).
 */
...
public class GoingToBackground extends APPIEvent
{
	 ...
	 *
	 */
	public GoingToBackground ()
	{
	   // For Jackson ObjectMapper's sanity!
		super ("GoingToBackground");
	}
	/*
	 * Setters
	 */
