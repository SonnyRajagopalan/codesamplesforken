 ...
 *
 * (Derived from APPIEvent object) Sent just before the app is going to the foreground (becomes active).
 */
...
public class GoingToForeground extends APPIEvent
{
	 ...
	 *
	 */
	public GoingToForeground ()
	{
	   // For Jackson ObjectMapper's sanity!
		super ("GoingToForeground");
	}
	/*
	 * Setters
	 */
