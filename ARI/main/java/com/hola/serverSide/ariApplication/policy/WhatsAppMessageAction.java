...
public class WhatsAppMessageAction extends Action
{
    // Logging
    private static final Logger log = LoggerFactory.getLogger (WhatsAppMessageAction.class.getName ());

    public WhatsAppMessageAction ()
    {
	super (ActionType.WhatsAppMessage);
    }
