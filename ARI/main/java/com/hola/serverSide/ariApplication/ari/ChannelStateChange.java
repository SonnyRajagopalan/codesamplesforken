 ...
 * Copyright, Pacifi, Inc.
 *
 * (Derived from Event object) Notification of a channel's state change.
 */
...
public class ChannelStateChange extends Event
{
	private Channel   channel; // Channel that changed state
	...
	public ChannelStateChange (String _type, String _application, Timestamp _timestamp, Channel _channel)
	{
