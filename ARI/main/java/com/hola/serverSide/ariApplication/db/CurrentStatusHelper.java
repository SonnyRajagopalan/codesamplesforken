...
/*
  Hola specific
*/
import com.hola.serverSide.ariApplication.db.beans.CurrentStatus;
...
public class CurrentStatusHelper
{
    ...
    public static CurrentStatus getCurrentStatusFromCurrentStatusDBByUserID (String userID)
    {
	Connection connectionFromHikariCP = HikariHelper.getADBConnection ();
	...
	try
	    ...
	    {
		log.error ("Error running SQl query for fetching user record for {} from currentStatus DB", userID);
		DbUtils.closeQuietly (connectionFromHikariCP);
		return null;
	    }
	finally
    ...
    public static boolean getCurrentStatusFromCurrentStatusDBByType (String userID, String infoType)
    {
	CurrentStatus currentStatus = getCurrentStatusFromCurrentStatusDBByUserID (userID);
